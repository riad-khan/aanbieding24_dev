...
import { stripTrailingSlash, splitComma, generateSlug } from '../../helpers/helperFunctions'
...
<template>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                    <div class="modal-product-info flex-col flex md:flex-row align-middle justify-between">
                        <div
                            class="img-box flex justify-center items-center relative h-[165px] w-full md:w-[273px] bg-[#F5F8FF]">
                            <div class="product-img p-8">
                                <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                                    src="@/assets/img/offers/keyboard.png" alt="image">
                            </div>
                        ...
                        <div class="product-details-s w-full pl-5">
                            ...
                            <div class="rating-area flex align-middle justify-start mb-5">
                                ...
                                <span class="review-status text-xs text-[#2B313B] font-bold ml-2">8.5</span><span
                                    class="total-review text-xs text[#6C7A93] font-normal ml-2">(10089 Reviews)</span>
                            </div>
                            <button type="button"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="text=[#FC7428] text-sm font-normal">Set Notification for this
                                        Product</span>
                                </div>
                                <div>
                            ...
                            <div class="brand-list-wrapper rounded-md border border-[#F5F8FF] bg-white">
                                <div class="brands-s flex items-center justify-between py-4 px-3 border-b border-[#F5F8FF]">
                                    ...
                                    <div class="price flex items-center align-bottom">
                                        ...
                                        <span
                                            class="original-price line-through text-[#D3D7DE] text-xs font-normal">$290</span>
                                    </div>
                                ...
                                <div
                                    class="stock-out brands-s flex items-center justify-between py-4 px-3 border-b border-[#F5F8FF]">
                                    <div class="modal-brand-logo flex h-4 w-auto">
                            ...
                            <div class="btn-area">
                                <button
                                    class="btn-translate-z bg-[#112954] w-auto opacity-100 hover:opacity-90 transition text-white flex text-sm font-bold text-center justify-center items-center rounded-md py-[10px] px-8 mx-auto mt-4 mb-8"><span
                                        class="flex items-center">Show More</span></button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="product-search-area mt-10">
        ...
        <div class="filter-wrapper flex flex-col lg:flex-row items-start lg:items-center justify-between">
            ...
            <div class="btn-area my-3 lg:my-0">
                <NuxtLink to="/category-details/top-ten"
                    class="flex items-center text-[#fff] text-xs font-bold bg-[#EF8421] transition hover:bg-[#d2751e] px-3 py-2 mr-4 md:mr-10 rounded-md">
                    <svg width="16" height="16" viewBox="0 0 16 16" class="mr-2" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
    ...
    <div class="center mt-7 grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-4 justify-between">
        <div class="item" v-for="product in props.products">

           

            <nuxt-link :to="'/products/' + generateSlug(product.product_title) + '-' + product.product_id"
                ...
                <div class="img-box flex justify-center items-center relative h-[165px] w-full bg-[#F5F8FF]">
                    <div class="product-img">
                        <img class="object-cover w-auto rounded-t-lg h-auto mx-auto"
                            :src="stripTrailingSlash(imageUrl) + product.url" alt="image">
                    </div>
                    <div class="brand-logo">
                        <img src="@/assets/img/providers/bol.com.png" alt="icon">
                    </div>
                ...
                <div class="flex justify-between items-center mt-2">
                    ...
                    <button type="button"
                        class="modal-btn view-icon py-2.5 px-2.5 ml-2 border transition-all border-[#112954] rounded-md"><svg
