...
<template>
    ...
    <div class="fav-offer-area mt-10">
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-10 p-10 bg-[#F5F8FF] rounded-md">
            ...
            <div>
                <div class="fav-offer-list mt-4">
                    <div class="grid grid-cols-2 ml-0 md:ml-8">
                        <div class="list-details">
                            <ul class="text-base font-bold text-[#0052FE] leading-loose">
                                <li>1. Dolce Gusto Cups</li>
                                <li>2. Senseo device</li>
                                <li>3. PlayStation 4</li>
                                <li>4. Pressure washer</li>
                                <li>5. Senseo device</li>
                            </ul>
                        </div>
                        <div class="list-details">
                            <ul class="text-base font-bold text-[#0052FE] leading-loose">
                                <li>6. Coffee machine</li>
                                <li>7. Printer</li>
                                <li>8. Philips Hue</li>
                                <li>9. Playstation 5</li>
                                <li>10. Vacuum Cleaner</li>
                            </ul>
                        </div>
                    </div>
                </div>
